...
<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/Mobiles.css">
    <script type="text/javascript" src="<%= request.getContextPath() %>/js/Mobiles.js"></script>
</head>
...
%>
    ...
    <main class="container">
        <section class="product-image">
            <img id="main-image" src="<%= request.getContextPath() %>/images/mobile.jpg" alt="Main Product Image">
            <div class="thumbnails">
                <img class="thumbnail" src="<%= request.getContextPath() %>/images/mobile.jpg" onclick="document.getElementById('main-image').src='<%= request.getContextPath() %>/images/mobile.jpg'" alt="Thumbnail 0">
                <img class="thumbnail" src="<%= request.getContextPath() %>/images/mobile1.jpg" onclick="document.getElementById('main-image').src='<%= request.getContextPath() %>/images/mobile1.jpg'" alt="Thumbnail 1">
                <img class="thumbnail" src="<%= request.getContextPath() %>/images/mobile2.jpg" onclick="document.getElementById('main-image').src='<%= request.getContextPath() %>/images/mobile2.jpg'" alt="Thumbnail 2">
                <img class="thumbnail" src="<%= request.getContextPath() %>/images/mobile3.jpg" onclick="document.getElementById('main-image').src='<%= request.getContextPath() %>/images/mobile3.jpg'" alt="Thumbnail 3">
            </div>
        </section>
        
        <section class="product-details">
            <h3 id="product1">Apple iPhone</h3>
            <h4 class="pr">PRICE : </h4><p class="price"> Rs.70,000/-</p><del class="del"> Rs.95,000/-</del><br>
            <p class="description">Apple iPhone 15 (Black, 128 GB)</p>
        <br>
            ...
            <h5>Key Features : </h5>
            <pre class="features">                128 GB ROM
                15.49 cm (6.1 inch) Super Retina XDR Display
                48MP + 12MP | 12MP Front Camera
                A16 Bionic Chip, 6 Core Processor Processor</pre>
        </section>
        ...
        <section class="reviews">
            ...
            <div class="review">
                ...
                <p class="reviewer">Vishwa</p>
                <p class="review-text">Amazing T- ... best quality</p>
                <% 
