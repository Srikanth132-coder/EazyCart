...
<head>
<meta charset="UTF-8">
<title>Fashion || E-Cart Commerce</title>
<link rel="stylesheet" type="text/css" href="<%= request.getContextPath() %>/css/Fashion.css">
    <script type="text/javascript" src="<%= request.getContextPath() %>/js/Fashion.js"></script>
</head>
...
%>
   ...
   <main class="container">
        <section class="product-image">
            <img id="main-image" src="<%= request.getContextPath() %>/images/tshirt.jpg" alt="Main Product Image">
            <div class="thumbnails">
                <img class="thumbnail" src="<%= request.getContextPath() %>/images/tshirt.jpg" onclick="document.getElementById('main-image').src='<%= request.getContextPath() %>/images/tshirt.jpg'" alt="Thumbnail 0">
                <img class="thumbnail" src="<%= request.getContextPath() %>/images/tshirt1.jpg" onclick="document.getElementById('main-image').src='<%= request.getContextPath() %>/images/tshirt1.jpg'" alt="Thumbnail 1">
                <img class="thumbnail" src="<%= request.getContextPath() %>/images/tshirt2.jpg" onclick="document.getElementById('main-image').src='<%= request.getContextPath() %>/images/tshirt2.jpg'" alt="Thumbnail 2">
                <img class="thumbnail" src="<%= request.getContextPath() %>/images/tshirt3.jpg" onclick="document.getElementById('main-image').src='<%= request.getContextPath() %>/images/tshirt3.jpg'" alt="Thumbnail 3">
            </div>
        </section>
        <section class="product-details">
            <h3>Eazy-Cart T-Shirt</h3>
            <h4 class="pr">PRICE : </h4><p class="price"> Rs.2500/-</p><del class="del"> Rs.7300/-</del><br>
            <p class="description">Men Solid Polo Neck Cotton Blend Black T-Shirt</p>
        <br>
