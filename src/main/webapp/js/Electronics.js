...
function addToCart() {
    var productName = 'Eazy-Cart Refrigrirator';
    var productPrice = 26900; 
    var productImage = 'refrigerator.jpg'; 
...
function handleSearch() {
    ...
    if (searchText.includes("fashion")) {
        window.location.href = "Fashion.jsp";
    } else if (searchText.includes("mobile")) {
        window.location.href = "Mobile.jsp";
    } else if (searchText.includes("electronics")) {
